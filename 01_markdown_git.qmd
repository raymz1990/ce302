...
## 1.1 <i class="fas fa-envelope"></i> Markdown
...
>Exemplo
>
><i class="fas fa-file-code-o"></i> **Código**
>
>```{r}
>># Título de Nível 1
>>## Título de Nível 2
...
><i class="fas fa-file-code-o"></i> **Código**
>
>```{latex, error=FALSE, warning = FALSE}
>> Isso é um parágrafo.
>> 
...
><i class="fas fa-file-code-o"></i> **Código**
>
>```{latex, warning = FALSE, error = FALSE}
...
A nomenclatura adequada dos arquivos é essencial para uma organização eficiente. Ao criar arquivos para projetos de análise de dados, independente da linguagem, devemos escolher nomes descritivos que reflitam o conteúdo ou a finalidade do arquivo. Por exemplo, `limpeza_dados.R` ou a`nalise_exploratoria.R` são nomes mais informativos do que `arquivo1.R` ou `script_final.R`.
...
### 1.5.1 <i class="fas fa-git"></i> Git
...
### 1.5.2 <i class="fas fa-github"></i> GitHub
...
1. Acesse o site oficial do GitHub em [https://github.com/](https://github.com/).
